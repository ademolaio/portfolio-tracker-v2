...
class editable_wheel(Command):
    ...
    def _select_strategy(
        ...
        if set(self.package_dir) == {""} and has_simple_layout or is_compat_mode:
            # utils-layout(ish) is relatively safe for a simple pth file
...
def _simple_layout(
    ...
    >>> _simple_layout(['a'], {"": "utils"}, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.b'], {"": "utils"}, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.b'], {}, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.a1', 'a.a1.a2', 'b'], {"": "utils"}, "/tmp/myproj")
    True
    ...
    False
    >>> _simple_layout(['a', 'a.b'], {"": "utils", "a.b": "_ab"}, "/tmp/myproj")
    False
    >>> # Special cases, no packages yet:
    >>> _simple_layout([], {"": "utils"}, "/tmp/myproj")
    True
    >>> _simple_layout([], {"a": "_a", "": "utils"}, "/tmp/myproj")
    False
    """
...
def _parent_path(pkg, pkg_path):
    ...
    own path.
    >>> _parent_path("a", "utils/a")
    'utils'
    >>> _parent_path("b", "utils/c")
    'utils/c'
    """
