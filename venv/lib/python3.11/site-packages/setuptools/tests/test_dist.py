...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "my_pkg",
            None,
            ["utils/my_pkg/__init__.py", "utils/my_pkg2/__init__.py"],
            ["my_pkg", "my_pkg2"],
        ),
        (
            "my_pkg",
...
def test_dist_default_packages(
    ...
    # Find `packages` either corresponding to dist_name or inside utils
    dist = Distribution(attrs)
    dist.set_defaults()
    assert not dist.py_modules
    assert not dist.py_modules
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("my_pkg", None, ["utils/my_pkg/__init__.py", "utils/my_pkg/nested/__init__.py"]),
        (
            "my_pkg",
        ...
        ("UNKNOWN", None, ["utils/mod1.py", "utils/mod2.py"]),
        ("UNKNOWN", None, ["utils/pkg1/__ini__.py", "utils/pkg2/__init__.py"]),
    ],
)
