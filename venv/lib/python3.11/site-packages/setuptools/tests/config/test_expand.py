...
class TestReadAttr:
    ...
    def test_import_order(self, tmp_path):
        ...
        """
        files = {
            "utils/pkg/__init__.py": "from .main import func\nfrom .about import version",
            "utils/pkg/main.py": "import super_complicated_dep\ndef func(): return 42",
            "utils/pkg/about.py": "version = '42'",
        }
        write_files(files, tmp_path)
...
@pytest.mark.parametrize(
    ...
    [
        ({"": "utils"}, "utils/pkg/main.py", "pkg.main", 42),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["utils/pkg1/__init__.py", "utils/pkg1/other.py"], ["utils"], {"": "utils"}),
        (["utils/pkg1/__init__.py", "utils/pkg2/__init__.py"], ["utils"], {"": "utils"}),
        (
        ...
        (
            ["utils/pkg1/__init__.py", "pkg2/__init__.py"],
            ["utils", "."],
            {"pkg1": "utils/pkg1"},
        ),
    ],
