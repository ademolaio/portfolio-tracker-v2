...
class TestMetadata:
    ...
    def test_version_with_package_dir_simple(self, tmpdir):
        _, config = fake_env(
            ...
            'package_dir =\n'
            '    = utils\n',
            package_path='utils/fake_package_simple',
        )
    ...
    def test_version_with_package_dir_complex(self, tmpdir):
        _, config = fake_env(
            ...
            '[options]\n'
            'package_dir =\n'
            '    fake_package_complex = utils/fake_dir\n',
            package_path='utils/fake_dir',
        )
...
class TestOptions:
    def test_basic(self, tmpdir):
        ...
        with deprec, get_dist(tmpdir) as dist:
            ...
            assert dist.package_dir == {'': 'utils', 'b': 'c'}
    ...
    def test_cmdclass(self, tmpdir):
        module_path = Path(tmpdir, "utils/custom_build.py")  # auto discovery for utils
