...
def test_get_outputs(tmpdir_cwd):
    ...
    assert mapping == {
        f"{build_lib}/mypkg/__init__.py": "utils/mypkg/__init__.py",
        f"{build_lib}/mypkg/resource_file.txt": "utils/mypkg/resource_file.txt",
        f"{build_lib}/mypkg/sub1/__init__.py": "utils/mypkg/sub1/__init__.py",
        f"{build_lib}/mypkg/sub1/mod1.py": "utils/mypkg/sub1/mod1.py",
        f"{build_lib}/mypkg/sub2/mod2.py": "utils/mypkg/_sub2/mod2.py",
