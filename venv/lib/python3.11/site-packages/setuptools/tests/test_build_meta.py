...
class TestBuildMetaBackend:
    ...
    def test_build_with_pyproject_config(self, tmpdir, setup_script):
        ...
        assert sdist_contents - {"foo-0.1/setup.py"} == {
            ...
            'foo-0.1/utils',
            'foo-0.1/utils/foo',
            'foo-0.1/utils/foo/__init__.py',
            'foo-0.1/utils/foo/__init__.pyi',
            'foo-0.1/utils/foo/cli.py',
            'foo-0.1/utils/foo/data.txt',
            'foo-0.1/utils/foo/py.typed',
            'foo-0.1/utils/foo.egg-info',
            'foo-0.1/utils/foo.egg-info/PKG-INFO',
            'foo-0.1/utils/foo.egg-info/SOURCES.txt',
            'foo-0.1/utils/foo.egg-info/dependency_links.txt',
            'foo-0.1/utils/foo.egg-info/entry_points.txt',
            'foo-0.1/utils/foo.egg-info/requires.txt',
            'foo-0.1/utils/foo.egg-info/top_level.txt',
            'foo-0.1/utils/foo.egg-info/not-zip-safe',
        }
