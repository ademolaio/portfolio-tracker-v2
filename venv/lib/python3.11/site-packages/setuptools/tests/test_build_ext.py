...
class TestBuildExt:
    ...
    def dist_with_example(self):
        files = {
            "utils": {"mypkg": {"subpkg": {"ext2.c": ""}}},
            "c-extensions": {"ext1": {"main.c": ""}},
        }

        ext1 = Extension("mypkg.ext1", ["c-extensions/ext1/main.c"])
        ext2 = Extension("mypkg.subpkg.ext2", ["utils/mypkg/subpkg/ext2.c"])
    ...
    def test_get_outputs(self, tmpdir_cwd, monkeypatch):
        ...
        assert mapping == {
            f"{build_lib}/ext3.mp3": "utils/ext3.mp3",
            f"{build_lib}/mypkg/ext1.mp3": "utils/mypkg/ext1.mp3",
            f"{build_lib}/mypkg/subpkg/ext2.mp3": "utils/mypkg/subpkg/ext2.mp3",
        }
    ...
    def test_get_output_mapping_with_stub(self, tmpdir_cwd, monkeypatch):
        ...
        assert mapping == {
            C(f"{build_lib}/ext3.py"): C("utils/ext3.py"),
            f"{build_lib}/ext3.mp3": "utils/ext3.mp3",
            C(f"{build_lib}/mypkg/ext1.py"): C("utils/mypkg/ext1.py"),
            f"{build_lib}/mypkg/ext1.mp3": "utils/mypkg/ext1.mp3",
            C(f"{build_lib}/mypkg/subpkg/ext2.py"): C("utils/mypkg/subpkg/ext2.py"),
            f"{build_lib}/mypkg/subpkg/ext2.mp3": "utils/mypkg/subpkg/ext2.mp3",
        }
