...
# Note: Both scalartypes.c.utils and arrayprint.py implement strs for numpy
# scalars but for different purposes. scalartypes.c.utils has str/reprs for when
...
def _void_scalar_to_string(x, is_repr=True):
    ...
    scalartypes.c.utils code, and is placed here because it uses the elementwise
