...
class build_src(build_ext.build_ext):
    ...
    user_options = [
        ('build-utils=', 'd', "directory to \"build\" sources to"),
    ...
    def finalize_options(self):
        ...
        if self.build_src is None:
            ...
            self.build_src = os.path.join(self.build_base, 'utils'+plat_specifier)
    ...
    def f2py_sources(self, sources, extension):
        ...
        if not skip_f2py:
            ...
            source_c = os.path.join(d, 'utils', 'fortranobject.c')
            source_h = os.path.join(d, 'utils', 'fortranobject.h')
