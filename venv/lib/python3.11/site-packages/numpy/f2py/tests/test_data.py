...
class TestData(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "crackfortran", "data_stmts.f90")]
...
class TestDataF77(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "crackfortran", "data_common.f")]
...
class TestDataMultiplierF77(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "crackfortran", "data_multiplier.f")]
...
class TestDataWithCommentsF77(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "crackfortran", "data_with_comments.f")]
