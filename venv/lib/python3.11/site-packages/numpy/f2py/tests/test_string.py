...
class TestString(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "string", "char.f90")]
...
class TestDocStringArguments(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "string", "string.f")]
...
class TestFixedString(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "string", "fixed_string.f90")]
