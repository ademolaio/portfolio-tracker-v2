...
class TestNoSpace(util.F2PyTest):
    ...
    sources = [util.getpath("tests", "utils", "crackfortran", "gh15035.f")]
...
class TestPublicPrivate:
    def test_defaultPrivate(self):
        fpath = util.getpath("tests", "utils", "crackfortran", "privatemod.f90")
    ...
    def test_defaultPublic(self, tmp_path):
        fpath = util.getpath("tests", "utils", "crackfortran", "publicmod.f90")
        mod = crackfortran.crackfortran([str(fpath)])
        assert len(mod) == 1
        mod = mod[0]
        assert "private" in mod["vars"]["a"]["attrspec"]
    ...
    def test_access_type(self, tmp_path):
        fpath = util.getpath("tests", "utils", "crackfortran", "accesstype.f90")
        mod = crackfortran.crackfortran([str(fpath)])
        assert len(mod) == 1
        tt = mod[0]['vars']
    ...
    def test_nowrap_private_proceedures(self, tmp_path):
        fpath = util.getpath("tests", "utils", "crackfortran", "gh23879.f90")
        mod = crackfortran.crackfortran([str(fpath)])
        assert len(mod) == 1
...
class TestModuleProcedure:
    def test_moduleOperators(self, tmp_path):
        fpath = util.getpath("tests", "utils", "crackfortran", "operators.f90")
        mod = crackfortran.crackfortran([str(fpath)])
        assert len(mod) == 1
        mod = mod[0]
    ...
    def test_notPublicPrivate(self, tmp_path):
        fpath = util.getpath("tests", "utils", "crackfortran", "pubprivmod.f90")
        mod = crackfortran.crackfortran([str(fpath)])
        assert len(mod) == 1
        mod = mod[0]
...
class TestExternal(util.F2PyTest):
    ...
    sources = [util.getpath("tests", "utils", "crackfortran", "gh17859.f")]
...
class TestCrackFortran(util.F2PyTest):
    ...
    sources = [util.getpath("tests", "utils", "crackfortran", "gh2848.f90")]
...
class TestModuleDeclaration:
    def test_dependencies(self, tmp_path):
        fpath = util.getpath("tests", "utils", "crackfortran", "foo_deps.f90")
        mod = crackfortran.crackfortran([str(fpath)])
        assert len(mod) == 1
...
class TestUnicodeComment(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "crackfortran", "unicode_comment.f90")]
...
class TestFunctionReturn(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "crackfortran", "gh23598.f90")]
...
class TestFortranGroupCounters(util.F2PyTest):
    def test_end_if_comment(self):
        # gh-23533
        fpath = util.getpath("tests", "utils", "crackfortran", "gh23533.f")
        try:
...
class TestF77CommonBlockReader:
    def test_gh22648(self, tmp_path):
        fpath = util.getpath("tests", "utils", "crackfortran", "gh22648.pyf")
