...
class TestF77Callback(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "callback", "foo.f")]
...
class TestF90Callback(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "callback", "gh17797.f90")]
...
class TestGH18335(util.F2PyTest):
    ...
    other tests!
    """
    sources = [util.getpath("tests", "utils", "callback", "gh18335.f90")]
...
class TestGH25211(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "callback", "gh25211.f"),
               util.getpath("tests", "utils", "callback", "gh25211.pyf")]
