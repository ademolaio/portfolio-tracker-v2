...
class TestStringScalarArr(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "string", "scalar_string.f90")]
...
class TestStringAssumedLength(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "string", "gh24008.f")]
...
class TestStringOptionalInOut(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "string", "gh24662.f90")]
...
class TestNewCharHandling(util.F2PyTest):
    ...
    sources = [
        util.getpath("tests", "utils", "string", "gh25286.pyf"),
        util.getpath("tests", "utils", "string", "gh25286.f90")
    ]
...
class TestBCCharHandling(util.F2PyTest):
    ...
    sources = [
        util.getpath("tests", "utils", "string", "gh25286_bc.pyf"),
        util.getpath("tests", "utils", "string", "gh25286.f90")
    ]
    module_name = "_char_handling_test"
