...
class TestParameters(util.F2PyTest):
    ...
    sources = [
        util.getpath("tests", "utils", "parameter", "constant_real.f90"),
        util.getpath("tests", "utils", "parameter", "constant_integer.f90"),
        util.getpath("tests", "utils", "parameter", "constant_both.f90"),
        util.getpath("tests", "utils", "parameter", "constant_compound.f90"),
        util.getpath("tests", "utils", "parameter", "constant_non_compound.f90"),
        util.getpath("tests", "utils", "parameter", "constant_array.f90"),
    ]
