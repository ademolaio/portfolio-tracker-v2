...
def hello_world_f90(tmpdir_factory):
    ...
    fdat = util.getpath("tests", "utils", "cli", "hiworld.f90").read_text()
...
def gh23598_warn(tmpdir_factory):
    ...
    fdat = util.getpath("tests", "utils", "crackfortran", "gh23598Warn.f90").read_text()
...
def gh22819_cli(tmpdir_factory):
    ...
    fdat = util.getpath("tests", "utils", "cli", "gh_22819.pyf").read_text()
...
def hello_world_f77(tmpdir_factory):
    ...
    fdat = util.getpath("tests", "utils", "cli", "hi77.f").read_text()
...
def retreal_f77(tmpdir_factory):
    """Generates a single f77 file for testing"""
    fdat = util.getpath("tests", "utils", "return_real", "foo77.f").read_text()
...
def f2cmap_f90(tmpdir_factory):
    """Generates a single f90 file for testing"""
    fdat = util.getpath("tests", "utils", "f2cmap", "isoFortranEnvMap.f90").read_text()
    f2cmap = util.getpath("tests", "utils", "f2cmap", ".f2py_f2cmap").read_text()
