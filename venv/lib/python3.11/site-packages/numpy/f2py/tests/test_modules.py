...
class TestModuleDocString(util.F2PyTest):
    sources = [util.getpath("tests", "utils", "modules", "module_data_docstring.f90")]
...
class TestModuleAndSubroutine(util.F2PyTest):
    module_name = "example"
    sources = [
        util.getpath("tests", "utils", "modules", "gh25337", "data.f90"),
        util.getpath("tests", "utils", "modules", "gh25337", "use_data.f90"),
    ]
...
class TestUsedModule(util.F2PyTest):
    module_name = "fmath"
    sources = [
        util.getpath("tests", "utils", "modules", "use_modules.f90"),
    ]
