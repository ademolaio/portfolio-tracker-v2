...
def run_main(comline_list):
    ...
    fobjhsrc = os.path.join(f2pydir, 'utils', 'fortranobject.h')
    fobjcsrc = os.path.join(f2pydir, 'utils', 'fortranobject.c')
    # gh-22819 -- begin
    parser = make_f2py_compile_parser()
    args, comline_list = parser.parse_known_args(comline_list)
    pyf_files, _ = filter_files("", "[.]pyf([.]utils|)", comline_list)
...
def run_compile():
    ...
    pyf_files, _sources = filter_files("", "[.]pyf([.]utils|)", sources)
