    ...
    def _get_test_address(self, test):
        try:
            if hasattr(test, "address"):
                ...
                # ('D:\\workspaces\\temp\\test_workspace\\pytesting1\\utils\\mod1\\hello.py', 'mod1.hello', 'TestCase.testMet1')
                #
                # and we must pass: location, test
                #    E.g.: ['D:\\utils\\mod1\\hello.py', 'TestCase.testMet1']
...
def new_consolidate(self, result, batch_result):
    ...
    # addr is something as D:\pytesting1\utils\mod1\hello.py:TestCase.testMet4
