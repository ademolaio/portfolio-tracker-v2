r"""
    ...
    E.g.:
        If the server (your python process) has the structure
            /user/projects/my_project/utils/package/module1.py

        and the client has:
            c:\my_project\utils\package\module1.py

        the PATHS_FROM_ECLIPSE_TO_PYTHON would have to be:
            PATHS_FROM_ECLIPSE_TO_PYTHON = [(r'c:\my_project\utils', r'/user/projects/my_project/utils')]

        alternatively, this can be set with an environment variable from the command line:
           set PATHS_FROM_ECLIPSE_TO_PYTHON=[['c:\my_project\utils','/user/projects/my_project/utils']]
...
# example:
# PATHS_FROM_ECLIPSE_TO_PYTHON = [
#  (r'd:\temp\temp_workspace_2\test_python\utils\yyy\yyy',
#   r'd:\temp\temp_workspace_2\test_python\utils\hhh\xxx')
# ]
