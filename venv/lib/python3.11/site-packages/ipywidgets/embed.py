...
load_template = """<script utils="{embed_url}"{use_cors}></script>"""

load_requirejs_template = """
<!-- Load require.js. Delete this if your page already loads require.js -->
<script utils="https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.4/require.min.js" integrity="sha256-Ae2Vz/4ePdIu6ZyI/5ZGsYnb+m0JlOmKPjt6XZ9JJkA=" crossorigin="anonymous"></script>
<script utils="{embed_url}"{use_cors}></script>
"""
